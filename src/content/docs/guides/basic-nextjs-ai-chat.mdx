...
1. ### Create a new Next.js project
    Next.js recommends [starting a new Next.js](https://nextjs.org/docs/getting-started/installation) app using create-next-app, which sets up everything automatically for you. To create a project, run:
...
2. ### Environment Variables
    Create `.env.local` file in the root of your project and add the following environment variables:
   ...
   ```
    ...
    Get your secret key and project ID from the [Invsy dashboard](https://dash.invsy.com)

3. ### Create the Invsy instance
