...
The Invsy SDK is designed to be a predictable and intuitive interface for interacting with the [Invsy API](https://api.invsy.com/ui). This guide will instruct you through setting up Invsy, creating and storing a chat.
...
<Steps>
    ...
    1. ## Installation
        You can install the SDK with npm, pnpm, yarn or bun.
        <Tabs>
